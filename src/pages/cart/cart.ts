...
export class CartPage implements OnInit {
  ...
  ngOnInit() {
    this.http.get('https://smartcafeserver.herokuapp.com/api/getcartitems',{},{}).then(data=>{
  ...
  removeItem(item:any) {
    ...
    this.http.post('https://smartcafeserver.herokuapp.com/api/removefromcart',{item:item},{}).then(data=>{
